...
var app=(function(){
   ...
   // var manager=new BookManager();
    ...
    var searchOptions={
        ...
        rating:{
            builder: createRangeInputBuilder("rating",0),
            handler: function(){
                var min= $("#min").val();
                var max= $("#max").val();
    ...
    function buildSearchUI(selectedType){
        ...
        for(var option in searchOptions){
            ...
            let optionData = searchOptions[option];
            
            eachOption.textContent=optionData.label;
            searchCriteriaDropDown.appendChild(eachOption)
    ...
    var handleSearch=function(){
        ...
        var searchResult= searchOptions[searchType].handler();
        
        if(searchType=='id'){''
            toEditor(searchResult);
                
        }else{
            refreshBookList(searchResult);
        }
